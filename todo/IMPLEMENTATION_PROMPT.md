...
- Все комментарии к функциям, типам, полям структур, пакетам — **на русском языке**
...
### 4. Комментирование
- Все комментарии — **на русском языке** (см. раздел «Язык комментариев» выше)
...
14. **Комментарии на русском** — весь проект комментируется на русском языке
