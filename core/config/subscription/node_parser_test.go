...
func TestIsDirectLink(t *testing.T) {
	tests := []struct {
		...
		{"Naive HTTPS link", "naive+https://user:pass@example.com:443", true},
		{"Naive QUIC link", "naive+quic://user:pass@example.com:443#JP", true},
		{"Naive without suffix (not a direct link)", "naive://example.com", false},
