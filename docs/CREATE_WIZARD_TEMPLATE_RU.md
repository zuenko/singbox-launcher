...
**Платформа:** только **`darwin`**. **Имя переменной:** логика привязана к **`name`** ровно **`tun`** (поставляемый **`bin/wizard_template.json`**).
